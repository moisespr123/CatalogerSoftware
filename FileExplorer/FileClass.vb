...
Public Class FileClass
    ...
    Public Sub New(file_name As String, file_type As String, file_mod_date As Date, file_size As Double, file_vol_label As String, file_checksum As String, file_orig_path As String, file_comment As String)
        Name = file_name
        Type = file_type
